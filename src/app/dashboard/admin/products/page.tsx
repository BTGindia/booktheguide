...
import { Package, Clock, CheckCircle, XCircle, Search, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Approve or reject guide tour packages</p>
      </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      By {product.guide.user.name} •{' '}
                      {product.destination.name}, {product.destination.city?.state?.name || ''} •{' '}
                      {product.durationDays} days •{' '}
                      {product.activityType === '__custom__' ? 'Custom' : product.activityType.replace(/_/g, ' ')}
                    </p>
                  </div>
