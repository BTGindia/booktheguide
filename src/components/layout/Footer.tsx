...
export async function Footer() {
  ...
  return (
    <footer className="bg-[#1A1A18]">
      {/* Main Footer Content */}
      <div className="px-4 sm:px-6 md:px-12 pt-10 sm:pt-16 pb-8 sm:pb-10">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr] gap-8 sm:gap-12 mb-10 sm:mb-14">
          {/* Brand Column */}
          <div className="col-span-2 md:col-span-2 lg:col-span-1">
            <div className="mb-3 sm:mb-4">
              <Image src="/images/btg-logo.webp" alt="Book The Guide — India's premier travel guide booking platform" width={120} height={40} className="h-8 sm:h-10 w-auto object-contain" />
            </div>
            <p className="text-[13px] sm:text-[14px] leading-[1.7] text-white/60 mb-5 sm:mb-7 max-w-[280px] font-body">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://instagram.com/booktheguide" target="_blank" rel="noopener noreferrer" title="Instagram"
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] flex items-center justify-center hover:scale-110 hover:shadow-[0_4px_20px_rgba(225,48,108,0.4)] transition-all active:scale-95">
              ...
              <a href="https://youtube.com/@booktheguide" target="_blank" rel="noopener noreferrer" title="YouTube"
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#FF0000] flex items-center justify-center hover:scale-110 hover:shadow-[0_4px_20px_rgba(255,0,0,0.3)] transition-all active:scale-95">
              ...
              <a href="https://x.com/booktheguide" target="_blank" rel="noopener noreferrer" title="X (Twitter)"
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white/10 flex items-center justify-center hover:scale-110 hover:bg-white/20 transition-all active:scale-95">
              ...
              <a href="https://linkedin.com/company/booktheguide" target="_blank" rel="noopener noreferrer" title="LinkedIn"
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#0A66C2] flex items-center justify-center hover:scale-110 hover:shadow-[0_4px_20px_rgba(10,102,194,0.3)] transition-all active:scale-95">
              ...
              <a href="https://facebook.com/booktheguide" target="_blank" rel="noopener noreferrer" title="Facebook"
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#1877F2] flex items-center justify-center hover:scale-110 hover:shadow-[0_4px_20px_rgba(24,119,242,0.3)] transition-all active:scale-95">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white/[0.08] px-4 sm:px-6 md:px-12 py-4 sm:py-6 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 mb-[72px] lg:mb-0">
