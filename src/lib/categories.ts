...
export const CATEGORY_MAP: Record<PackageCategorySlug, CategoryDefinition> = {
  ...
  GROUP_TRIPS: {
    ...
    urlSlug: 'group-trips',
    label: 'Group Trips',
    image: 'https://images.unsplash.com/photo-1682686581030-7fa4ea2b96c3?w=800&q=80',
  ...
  ADVENTURE_GUIDES: {
    ...
    activityTypes: ['Mountaineering Workshop', 'Paragliding', 'Rafting', 'Skiing', 'Rock Climbing', 'Bungee Jumping'],
  ...
  OFFBEAT_TRAVEL: {
    ...
    activityTypes: ['Offbeat Destinations', 'Hidden Gems', 'Village Stays', 'Unexplored Trails', 'Slow Travel'],
  ...
  TREKKING: {
    ...
    activityTypes: ['Trekking', 'High Altitude Treks', 'Day Treks', 'Multi-day Treks', 'Snow Treks'],
